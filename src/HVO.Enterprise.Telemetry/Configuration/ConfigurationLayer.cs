...
{
    /// <summary>
    /// Represents a configuration layer applied during evaluation.
    /// </summary>
    public sealed class ConfigurationLayer
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfigurationLayer"/> class.
        /// </summary>
        ...
        /// <param name="configuration">Configuration applied at this layer.</param>
        ...
        /// <summary>
        /// Gets the identifier for the configuration (namespace/type/method).
        /// </summary>
        public string? Identifier { get; }

        /// <summary>
        /// Gets the configuration applied at this layer.
        /// </summary>
