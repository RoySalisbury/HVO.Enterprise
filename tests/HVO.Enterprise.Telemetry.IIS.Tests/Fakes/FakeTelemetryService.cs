...
namespace HVO.Enterprise.Telemetry.IIS.Tests.Fakes
{
    /// <summary>
    /// Fake telemetry service for testing IIS extension components.
    ...
    internal sealed class FakeTelemetryService : ITelemetryService
    {
        ...
        public ITelemetryStatistics Statistics =>
            throw new NotImplementedException("Not needed for IIS extension tests");
